...
<body>
  ...
  <main>
    <div>
      <form method="POST" action="/store" enctype="multipart/form-data" class="form w-500px margin-x-auto">
        ...
        <?php endif?>
        <input class="margin-b-16px" type="text" name="nama" placeholder="nama mahasiswa" value="<?php echo isset($_POST['nama']) ? $_POST['nama'] : ''?>"/>
        <input class="margin-b-16px" type="number" step="0.01" max="4" min="0" name="ipk" placeholder="ipk" value="<?php echo isset($_POST['ipk']) ? $_POST['ipk'] : ''?>"/>
        <textarea rows="8" type="text" placeholder="biodata" name="biodata"><?php echo isset($_POST['biodata']) ? $_POST['biodata'] : ''?></textarea>
